    ...
    const fetchContributionDetails = async () => {
      try {
        ...
        const scholarshipResponse = await apiClient.get(
          `/scholarships/${contributionId}/`
        );
        const scholarshipData = scholarshipResponse.data;

        // Fetch contributors list
        const contributorsResponse = await apiClient.get(
          `/scholarships/${contributionId}/endowment/list/`
        );
  ...
  const handleDonate = async () => {
    try {
      ...
      await apiClient.post(
        `/scholarships/${contributionId}/endowment/`,
        contributionData
      );
