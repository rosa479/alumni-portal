      ...
      <div className="container mx-auto p-4 lg:p-8">
        ...
        <div className="mb-12">
          <div className="bg-white rounded-3xl shadow-2xl p-8 mb-8 border border-gray-100">
            <h1 className="text-5xl font-bold text-gray-800 mb-4">Discover Communities</h1>
            <p className="text-xl text-gray-600 mb-8">Find and join groups that match your interests and professional goals.</p>
        ...
        {searchTerm && (
          <div className="mb-8">
            <p className="text-lg text-gray-600">
              {filteredCommunities.length} community{filteredCommunities.length !== 1 ? 'ies' : ''} found for "{searchTerm}"
            </p>
          </div>
        )}
          ...
          {filteredCommunities.length > 0 ? (
            ...
            <div className="col-span-full text-center py-12">
              <div className="bg-white rounded-2xl shadow-lg p-12 border border-gray-100">
                ...
                <h3 className="text-2xl font-semibold text-gray-500 mb-2">No communities found</h3>
                <p className="text-gray-400 mb-6">Try adjusting your search terms or browse all communities.</p>
                <button
