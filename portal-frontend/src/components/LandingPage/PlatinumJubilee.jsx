    ...
    <div id="platinum" className="bg-[#F0F7FF] font-sans">
      <main className="px-6 md:px-12 lg:px-20">
        ...
        <section className="relative pt-10 pb-5 text-center">
          ...
          <div className="relative md:flex-col md:items-center md:justify-start">
            {/* On desktop, it takes up ~30% of the width. */}
            <div className="md:hidden md:w-[30%] md:h-full md:relative">
              {/* Floating PNG */}
              <motion.img
            ...
            <div className="relative z-10 md:w-full flex flex-row items-center md:items-start">
              <div className="hidden md:block md:w-[30%] md:ml-[10%] md:h-full md:relative">
                {/* Floating PNG */}
                <motion.img
                  src={floatingPngPlaceholder}
                  alt="Floating Jubilee Icon"
                  // Mobile: Centered, relative positioning. Desktop: Absolute positioning.
                  className="relative mx-auto mb-8 w-32 h-32 md:mx-0 md:mb-0 z-20 md:left-[35%] md:top-[30%] md:w-[64%] md:h-[64%] object-contain"
                  initial={{ opacity: 0, scale: 0.5, x: -100 }}
                  animate={{ opacity: 1, scale: 1, x: 0 }}
                  transition={{ duration: 1.5, ease: "easeInOut" }}
                />
              ...
              <motion.div
                className="text-left text-base md:text-lg md:ml-[5%] space-y-3 text-black p-6 rounded-lg w-full max-w-lg"
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
