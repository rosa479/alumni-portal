...
function CommentSection({ comments }) {
  return (
    <div className="bg-white p-6 rounded-xl shadow-lg mt-8">
      <h3 className="text-xl font-bold text-dark-text mb-6">{comments.length} Comments</h3>
      
      {/* Add a Comment Form */}
      <div className="flex items-start gap-4 mb-8">
        <img src="https://i.pravatar.cc/150?u=a042581f4e29026704d" alt="My Profile" className="w-10 h-10 rounded-full" />
